...
\newcommand{\corobool}{\cpp{std::coroutine<>::operator bool()}\xspace}
...
\newcommand{\pullcorobool}{\cpp{std::pull_coroutine<>::operator bool()}\xspace}
\newcommand{\pullcoro}{\cpp{std::pull_coroutine<>}\xspace}
\newcommand{\pullcoroget}{\cpp{std::pull_coroutine<>::get()}\xspace}
\newcommand{\pullcoroiterator}{\cpp{std::pull_coroutine<>::iterator}\xspace}
\newcommand{\pullcoroop}{\cpp{std::pull_coroutine<>::operator()()}\xspace}
\newcommand{\pushcorobool}{\cpp{std::push_coroutine<>::operator bool()}\xspace}
