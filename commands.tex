...
\lstset{basicstyle=\ttfamily\small\color{black},
        ...
        language={C++},
        morekeywords={await,from,noexcept,resumable,yield},
        showspaces=false,
...
\newcommand{\susreturn}{\emph{suspend-on-return}\xspace}
\newcommand{\suscall}{\emph{suspend-on-call}\xspace}
