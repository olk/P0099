...
\begin{tabular}{ l l }
    ...
    \cpp{template<class T> class coroutine<T>::pull_type;} & (1)\\

    \midrule

    \cpp{template<class T> class coroutine<T>::pull_type<T&>;} & (2)\\

    \midrule

    \cpp{template<> class coroutine<T>::pull_type<void>;} & (3)\\
...
\begin{description}
    \item[1)] creates and returns an \cpp{std::input_iteror}
\end{description}
...
\begin{description}
    \item[1)] creates and returns an \cpp{std::input_iteror} indicating the termination of the coroutine
\end{description}

Incrementing the iterator switches the execion context. If
\cpp{iterator::operator++()} returns, the other context has transferred control
of execution back and a data value can be accessed via
...
\begin{tabular}{ l l }
    ...
    \cpp{template<class T> class coroutine<T>::push_type;} & (1)\\

    \midrule

    \cpp{template<class T> class coroutine<T>::push_type<T&>;} & (2)\\

    \midrule

    \cpp{template<> class coroutine<T>::push_type<void>;} & (3)\\
...
\begin{description}
    \item[1)] creates and returns an \cpp{std::output_iteror}
\end{description}
...
\begin{description}
    \item[1)] creates and returns an \cpp{std::output_iteror} indicating the termination of the coroutine
\end{description}

Incrementing the iterator switches the execion context and transferres the data value.\\
