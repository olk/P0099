...
\begin{tabular}{ l l }
    ...
    \cpp{template<class T> class coroutine<T&>::pull_type;} & (2)\\

    \midrule

    \cpp{template<> class coroutine<void>::pull_type;} & (3)\\
...
\begin{tabular}{ l l }
    ...
    \cpp{template<class T> class coroutine<T&>::push_type;} & (2)\\

    \midrule

    \cpp{template<> class coroutine<void>::push_type;} & (3)\\
