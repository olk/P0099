...
\begin{tabular}{ l l }
    ...
    \cpp{pull_coroutine(Function&& fn,std::size_t ssize=min_ssize);} & (2)\\

    \midrule

    \cpp{pull_coroutine(Function&& fn,const StackAllocator& salloc,std::size_t ssize=min_ssize);} & (3)\\

    \midrule

    \cpp{pull_coroutine(pull_coroutine&& other);} & (4)\\

    \midrule

    \cpp{pull_coroutine(const pull_coroutine& other)=delete;} & (5)\\
...
\begin{tabular}{ l l }
    ...
    \cpp{pull_coroutine & operator=(const pull_coroutine& other)=delete;} & (2)\\
...
\begin{tabular}{ l l }
    ...
    \cpp{push_coroutine(Function&& fn,ssize_t ssize=min_ssize);} & (2)\\

    \midrule

    \cpp{push_coroutine(Function&& fn,const StackAllocator& salloc,std::size_t ssize=min_ssize);} & (3)\\

    \midrule

    \cpp{push_coroutine(push_coroutine&& other);} & (4)\\

    \midrule

    \cpp{push_coroutine(const push_coroutine& other)=delete;} & (5)\\
...
\begin{tabular}{ l l }
    ...
    \cpp{push_coroutine & operator=(const push_coroutine& other)=delete;} & (2)\\
